...
def relu_layer_dropout(X, dout, name):
    return tf.nn.dropout(tf.nn.relu(linear(X, dout, name)),0.9)
...
def load_prior_params(pkl_fname):
    ...
    #irl_params = params['irl_params']
    #empw_params = params['empw_params']
    #qvar_params = params['qvar_params']
    #print(params)
